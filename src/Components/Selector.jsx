...
function Selector ({
  ...
  return (
    ...
    <select className="w-11/12 h-12 bg-text-sec px-2 sm:max-w-lg py-2 italic border shadow-lg border-gray-800/25 rounded-lg m-auto text-text_main" onChange={(e) => handleCityChange(e.target.value)}>
